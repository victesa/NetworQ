...
fun GreenLeafCard(
    ...
    Box{
        Image(
            painter = painterResource(com.victorkirui.resources.R.drawable.green_leaf_card),
        ...
        Row(modifier = Modifier.matchParentSize()){
            Column(modifier = Modifier
                ...
                Text(fullName, style = MaterialTheme.typography.titleMedium, fontSize = 48.sp, color = Color.White)

                if (jobTitle.isNotEmpty()){
                    Text(jobTitle, color = Color.Gray, fontSize = 22.sp, fontWeight = FontWeight.SemiBold)
                }

                HorizontalDivider(color = Color(0xFF3bc155), thickness = 2.dp, modifier = Modifier.width(50.dp).padding(top = 10.dp))
                ...
                if (phoneNumber.isNotEmpty() || emailAddress.isNotEmpty()){
                    Row(modifier = Modifier
                        ...
                        Box(modifier = Modifier
                            .size(50.dp)
                            .background(color = Color(0xFF3bc155), shape = CircleShape),
