...
fun RedPhoenixCard(
    ...
    Box{
        Image(
            painter = painterResource(com.victorkirui.resources.R.drawable.red_phoenix_card),
        ...
        Row(modifier = Modifier.matchParentSize()){
            Column(modifier = Modifier
                ...
                HorizontalDivider(color = Color.Red, thickness = 2.dp, modifier = Modifier.width(50.dp).padding(top = 10.dp))
